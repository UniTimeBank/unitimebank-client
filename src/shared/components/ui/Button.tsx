...
export const Button = ({
  ...
  const variants = {
    ...
    danger:
      'bg-red-600 text-white hover:bg-red-700 active:bg-red-800 shadow-md shadow-red-600/20 hover:shadow-lg hover:shadow-red-600/30 disabled:hover:bg-red-600 disabled:active:bg-red-600 disabled:shadow-none',
  };
